...
const router =   createBrowserRouter([
      ...
      children :[
        {
            path: "/",
            element: <Home></Home>,
            loader : () => fetch('https://b8a11-server-side-sanjida-mitu123.vercel.app/jobs')
        },
        {
          path : "/login",
          element : <Login></Login>,
  ...
  } ,
  {
    ...
    loader : ({params})=> fetch(`https://b8a11-server-side-sanjida-mitu123.vercel.app/jobs/${params.id}`)
...

{
  ...
  loader : () => fetch('https://b8a11-server-side-sanjida-mitu123.vercel.app/bids')
